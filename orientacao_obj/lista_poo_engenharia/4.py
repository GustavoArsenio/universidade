...
def rect_in_circle(rectangle:Rectangle, circle:Circle):
    return  point_in_circle(rectangle.upper_point,circle)  and point_in_circle(rectangle.lower_point,circle)
...
if __name__ == '__main__':
    ...
    print(f" rectangle_in          : { rect_in_circle( rectangle_in         , my_circle ) }")
    print(f" rectangle_partial_in  : { rect_in_circle( rectangle_partial_in , my_circle ) }")
    print(f" rectangle_out         : { rect_in_circle( rectangle_out        , my_circle ) }")